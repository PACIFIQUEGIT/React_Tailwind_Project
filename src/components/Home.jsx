...
export const Home = () => {
  ...
  return (
    <>
      ...
      {/* How to Help Section */}
      <div className="flex flex-col md:flex-row p-12 justify-between">
        <div className="relative h-[385px] flex-grow w-full md:w-1/2">
          <div className="absolute right-11 p-14 h-[385px] w-[60%] bg-cover bg-center bg-[url('/dcs.jpg')]"></div>
          <div className="absolute left-12 top-28 p-14 h-[320px] w-[41%] bg-cover bg-center bg-[url('/DSC.avif')]"></div>
        </div>
      ...
      <div className="flex flex-col md:flex-row bg-gray-300 p-6 md:p-12">
        ...
        <div className="right w-full md:w-1/2 px-6 md:px-12">
