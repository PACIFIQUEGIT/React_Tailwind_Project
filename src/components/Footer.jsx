        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            >
              ...
              <li><Link to="/donate" className="hover:text-yellow-500 bg-green-500 text-white p-2 rounded-lg transition-colors">Donate</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <Link to="https://facebook.com" className="hover:text-yellow-500 transition-colors" target="_blank" rel="noopener noreferrer">
              <MdFacebook /> {/* Facebook Icon */}
              </Link>
              <Link to="https://twitter.com" className="hover:text-yellow-500 transition-colors" target="_blank" rel="noopener noreferrer">
              <AiFillTwitterCircle /> {/* Twitter Icon */}
              </Link>
              <Link to="https://instagram.com" className="hover:text-yellow-500 transition-colors" target="_blank" rel="noopener noreferrer">
              <AiFillInstagram /> {/* Instagram Icon */}
              </Link>
              <Link to="https://linkedin.com" className="hover:text-yellow-500 transition-colors" target="_blank" rel="noopener noreferrer">
